import "../_runtime.mjs";
import { l as require_jsx_runtime, u as require_react } from "../_libs/@convex-dev/auth+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BhZ5grkt.mjs");
